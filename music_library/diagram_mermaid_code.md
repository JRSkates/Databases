sequenceDiagram
    ...
    app->>ar: Calls `all` method on a new instance of AlbumRepository
    ...
    loop 
        ar->>ar: Loops through array and creates an Album object for every row (/hash)
    end
    ar->>app: Returns an array of Album objects
